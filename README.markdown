# javascript-koans-evergreen
Combining [mrdvaidlaing](https://github.com/mrdavidlaing/javascript-koans)'s and [liammclennan](https://github.com/liammclennan/JavaScript-Koans)'s as well as our own koans to keep evergreen with JavaScript.

Originally ased on Edgecase's fantastic [Ruby koans](http://github.com/edgecase/ruby_koans), the goal of the Javascript koans is to teach you Javascript programming through testing.
